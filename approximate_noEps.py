...
class approximate(object):
    ...
    def linearize(self):
        ...
        self.dy[Eps] = lambda z_i : np.zeros((ny,nEps))
        self.dY_Eps = np.zeros((nY,nEps))
    ...
    def quadratic(self):
        ...
        '''
        self.d2Y,self.d2y = {},{}
        self.dYGamma_Eps = np.zeros((nY,nEps))#self.integrate(lambda z_i: self.dY(z_i).dot(Izy).dot(self.dy[Eps](z_i)))
        ...
        self.d2y[Eps,Eps] = lambda z_i : np.zeros((ny,nEps,nEps))
        self.d2y[Eps,Z] = lambda z_i : np.zeros((ny,nEps,nZ))
        self.d2y[Z,Eps] = lambda z_i : np.zeros((ny,nZ,nEps))
        self.d2y[Eps,p] = lambda z_i : np.zeros((ny,nEps,n_p))
        self.d2y[p,Eps] = lambda z_i : np.zeros((ny,n_p,nEps))
        self.d2y[sigma_E] = lambda z_i: np.zeros((ny,nEps,nEps))
        
        self.d2Y[Eps,Eps] = np.zeros((nY,nEps,nEps))
        self.d2Y[Eps,Z] =  np.zeros((nY,nEps,nZ))
        self.d2Y[Z,Eps] =  np.zeros((nY,nZ,nEps))
        self.d2Y[Eps,p] =  np.zeros((nY,nEps,n_p))
        self.d2Y[p,Eps] =  np.zeros((nY,n_p,nEps))
        self.d2Y[sigma_E] =  np.zeros((nY,nEps,nEps))
